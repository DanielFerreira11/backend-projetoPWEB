 ...
 */
router.post("/class", authenticate, ClassController.create);
 ...
 *         description: Internal server error
 */
router.put("/class/:id", authenticate, ClassController.update);
 ...
 *         description: Internal server error
 */
router.delete("/class/:id", authenticate, ClassController.delete);
